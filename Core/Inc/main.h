...
#define OUT_INnb_ENGINE_LEFT_Pin GPIO_PIN_2
#define OUT_INnb_ENGINE_LEFT_GPIO_Port GPIOC
...
#define OUT_INb_RIGHT_Pin GPIO_PIN_9
#define OUT_INb_RIGHT_GPIO_Port GPIOC
