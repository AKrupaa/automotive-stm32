...
#define BLE_TRANSMIT_ULTRASOUND_VALUE 0x0A
#define BLE_TRANSMIT_PHOTOTRANSISTOR_FRONT_VALUE 0x0B
#define BLE_TRANSMIT_PHOTOTRANSISTOR_BACK_VALUE 0x0C
#define BLE_TRANSMIT_HALL_FRONT_VALUE 0x0D
