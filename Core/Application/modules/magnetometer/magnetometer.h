...
#define MAGNETOMETR_DEVICE_ADDRESS (0x1E<<1)
...
#define QMC5883L_DATA_READ_X_MSB	0x03
#define QMC5883L_DATA_READ_Y_LSB	0x08
#define QMC5883L_DATA_READ_Y_MSB	0x07
#define QMC5883L_DATA_READ_Z_LSB	0x06
#define QMC5883L_DATA_READ_Z_MSB	0x05
#define QMC5883L_TEMP_READ_LSB		0x07
#define QMC5883L_TEMP_READ_MSB		0x08
#define QMC5883L_STATUS		        0x09 // DOR | OVL | DRDY
...
typedef enum MODE_VARIABLES {
	MODE_CONTROL_STANDBY = 0x01, MODE_CONTROL_CONTINUOUS = 0x00
} _qmc5883l_MODE;
